 ...
 */
public class AlarmSuccessList extends Fragment {

    DB_Helper database;
    List<Alarm> alarmList = new ArrayList<>();
    RecyclerView recyclerView;
    ProgressDialog dialog;
    AlarmSuccessListAdapter adapter;

    public AlarmSuccessList() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        alarmList = database.getdataOrderBySuccess();
    ...
    private void loadData() {
        adapter = new AlarmSuccessListAdapter(getContext(),alarmList);
